...
public class SimpleLiteActivity extends AndSketch implements AndGLView.IGLFunctionEvent
{
	...
	public void setupGL(GL10 gl)
	{
		try
		{
			...
			this.glt01 = new GlTest01(this._glv, gl);  // Add yama
...
//					this.box.draw(0,0,20);  // Del yama
					this.glt01.draw(0, 0, 20);  // add yama
				}
		}
		}catch(Exception e)
		{
